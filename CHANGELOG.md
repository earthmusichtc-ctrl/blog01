...
## [0.6.0](https://github.com/earthmusichtc-ctrl/blog01/compare/v0.5.0...v0.6.0) (2026-08-30)
...
* add CI workflow for type checking and building the project ([8e600ad](https://github.com/earthmusichtc-ctrl/blog01/commit/8e600addadc7e21b974f01fb581cceaafe3f2b1c))
* Add CLAUDE.md to .gitignore ([9ff2793](https://github.com/earthmusichtc-ctrl/blog01/commit/9ff27938a4312188d0275edb65e029fb72b3e9a4))
* add copy-to-clipboard button on code blocks ([0000136](https://github.com/earthmusichtc-ctrl/blog01/commit/000013622ab774fd8cdc6da4500588bb33dd94d1))
* add copyright display option to Footer component ([d164696](https://github.com/earthmusichtc-ctrl/blog01/commit/d164696d9c032c6522265ceff76dbe81daf5a062))
* add GitHub Pages deploy workflow and fix base path handling for Astro 6 ([9b761df](https://github.com/earthmusichtc-ctrl/blog01/commit/9b761df54905f35245968cb913205a21bc0e60b9))
* add portfolio page ([208e093](https://github.com/earthmusichtc-ctrl/blog01/commit/208e09359d9ee7afb46ea9a43f4231470b279286))
* add production-only GA4 analytics with content dimensions and engagement events ([b4085ca](https://github.com/earthmusichtc-ctrl/blog01/commit/b4085cadc38f43f85cc902377c4642f38437af04))
* add reading time estimate and previous/next post navigation ([974f318](https://github.com/earthmusichtc-ctrl/blog01/commit/974f318179f7c84146fcf80c0798ba89d642265c))
* add RSS feed with autodiscovery link and footer icon ([a6cfa35](https://github.com/earthmusichtc-ctrl/blog01/commit/a6cfa35b4c394a918f04005f47add8b6f8cc5557))
* Add SEO component and site configuration ([7601460](https://github.com/earthmusichtc-ctrl/blog01/commit/7601460c2b36ecd888d18dd9593d4bd8f1422c87))
* add tag index and per-tag listing pages from post keywords ([e13c3c9](https://github.com/earthmusichtc-ctrl/blog01/commit/e13c3c923a98d8a7b2c2be516e02394d89904a9a))
* add versioning scripts and changelog management ([7f4e307](https://github.com/earthmusichtc-ctrl/blog01/commit/7f4e307c40f4bf7dcffbd92550efdeed5d0d7f6c))
* align footer social icons left and copyright right in a single row ([46cd184](https://github.com/earthmusichtc-ctrl/blog01/commit/46cd18498967e649d3fa4795d2db13fe84494363))
* deploy Astro 6 live demo via GitHub Pages Actions workflow ([da47aeb](https://github.com/earthmusichtc-ctrl/blog01/commit/da47aeb25495c4702ad21399da2ce994099676c5))
* implement automated release process with GitHub Actions and add release notes ([9e32b25](https://github.com/earthmusichtc-ctrl/blog01/commit/9e32b257ef5cf0a09b31d0122d54e460abe963d6))
* link footer socials to platform home pages, swap Twitter bird for X logo, shrink icons ([2f70a17](https://github.com/earthmusichtc-ctrl/blog01/commit/2f70a171ebe6f653b5dd45ade16b7e5f3faa681f))
* syntax highlighting via Shiki with GitHub light/dark themes following site theme ([9da4494](https://github.com/earthmusichtc-ctrl/blog01/commit/9da44940c01fec761cd31daf96d7b6e61b32bf2d))
* upgrade to Astro 7, Tailwind 4.3.2; drop obsolete dependency overrides ([c11775b](https://github.com/earthmusichtc-ctrl/blog01/commit/c11775b0c093f9d593b4e6cb7197b59f764de305))
* use an always-visible icon for the code copy button ([ba5a6c3](https://github.com/earthmusichtc-ctrl/blog01/commit/ba5a6c3570c463412df70fde0c177fb36fbfbf76))


### Bug Fixes

* add missing space in footer copyright and show social icons without heading ([b4b0123](https://github.com/earthmusichtc-ctrl/blog01/commit/b4b01232176a0d82d4ce3dd54106eebd87554c08))
* dedupe tag slugs per post to prevent duplicate listings and inflated counts ([da720b6](https://github.com/earthmusichtc-ctrl/blog01/commit/da720b60a17b769c614d0a5a41a9b68f999f5572))
* drop Twitter and email lines from the about page contact list ([ad7876f](https://github.com/earthmusichtc-ctrl/blog01/commit/ad7876f7b8717d3b380264fc700c5ba1ffe3c1ac))
* give every demo post a distinct cover image, refresh README screenshot ([e3edf52](https://github.com/earthmusichtc-ctrl/blog01/commit/e3edf526bf9df8a8a2153ad572f3b0f2c53635f8))
* give light mode code blocks a subtle gray background ([47f3153](https://github.com/earthmusichtc-ctrl/blog01/commit/47f3153753a0bcdfdabe4aaf70697cb031e6e426))
* improve changelog extraction logic for version releases ([215bb43](https://github.com/earthmusichtc-ctrl/blog01/commit/215bb4324d899385b8e13bc5fae146990bc1587f))
* normalize demo cover images to real photos at consistent size and weight ([8662fb1](https://github.com/earthmusichtc-ctrl/blog01/commit/8662fb1dd0b53c8ac7aad57945092757dff01019))
* Remove Bootstrap references from README, package.json, and about.astro ([1037807](https://github.com/earthmusichtc-ctrl/blog01/commit/103780744dd031a3f631bfff2fd2ba9e4326014c))
* remove tags link from the navigation menu ([1bbf118](https://github.com/earthmusichtc-ctrl/blog01/commit/1bbf11862d7ec04dffdb6417e28616770b7c253f))
* render dark mode toggle icon via CSS to prevent flash and wire all toggle instances ([bf6ea6e](https://github.com/earthmusichtc-ctrl/blog01/commit/bf6ea6ec5532e3f738d3eb0f93c745bfb01b7a65))
* repair broken demo post image and add missing README screenshot ([915382d](https://github.com/earthmusichtc-ctrl/blog01/commit/915382da46e7098ca2187ef57ae1774e3818e7e5))
* reserve scrollbar gutter to prevent layout shift between pages ([529b17c](https://github.com/earthmusichtc-ctrl/blog01/commit/529b17cd572512c0a449970941ffd62b8f8cca3a))
* show copyright in the homepage footer ([d98b34d](https://github.com/earthmusichtc-ctrl/blog01/commit/d98b34dccbd2bd224a668bb955fe4a989ce2c35f))
* tighten footer padding, refresh about page copy, point portfolio samples at GitHub ([625308c](https://github.com/earthmusichtc-ctrl/blog01/commit/625308ca590f3105527c6dafc988fbf2e013c186))
* upgrade Node.js to 22 in CI and release workflows (Astro 6 requires &gt;=22.12.0) ([5b09c4d](https://github.com/earthmusichtc-ctrl/blog01/commit/5b09c4d981a1ea3c16e6deed92a38745bb68e902))
* use placeholder projects on the portfolio page ([01825c3](https://github.com/earthmusichtc-ctrl/blog01/commit/01825c3967edeb752689b2b36957a70c7fe03acf))
